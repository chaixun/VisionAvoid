...
void AvoidancePlanner::GenBodyPoses()
{
	...
	//for (unsigned int i = 0; i < bodyPoses.size(); i++)
	//{
	//	cout << bodyPoses[i].x << " " << bodyPoses[i].y << " " << bodyPoses[i].z << " " << bodyPoses[i].alpha << " " << bodyPoses[i].beta << " " << bodyPoses[i].gama << endl;
	//}

	//cout << "time 0 " << timeSeg[0] << endl;
	//cout << "time 1 " << timeSeg[1] << endl;
}
...
void AvoidancePlanner::GenFeetHolds()
{
	...
	//for (unsigned int i = 0; i < feetPoses.size(); i++)
	//{
	//	cout << feetPoses[i].feetHold[0] << " " << feetPoses[i].feetHold[1] << " " << feetPoses[i].feetHold[3] << " " << feetPoses[i].feetHold[4] << " " << feetPoses[i].feetHold[6] << " " << feetPoses[i].feetHold[7] << " " << feetPoses[i].feetHold[9] << " " << feetPoses[i].feetHold[10] <<
	//		" " << feetPoses[i].feetHold[12] << " " << feetPoses[i].feetHold[13] << " " << feetPoses[i].feetHold[15] << " " << feetPoses[i].feetHold[16] << endl;
	//}
